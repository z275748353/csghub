export const dataPipelines = {
 ...
 "raw_arxiv_to_jsonl_preprocess_internal": "raw arxiv to jsonl preprocess",
  ...
  "streamingModeBenefits": "Benefits of Streaming Mode:",
  "streamingBenefit1": "Significantly reduces memory usage, ideal for large-scale data processing",
  "streamingBenefit2": "Read and process simultaneously for improved efficiency",
  "streamingBenefit3": "Handles extremely large files without memory limitations",
  "executionModeTitle": "Execution Mode Selection",
  "executionMode": "Execution Mode",
  "normalMode": "Normal Mode",
  "streamingMode": "Streaming Mode",
  "normalExecution": "Normal",
  "streamingExecution": "Streaming",
  "streamingCompatibleDetected": "All operators in your workflow support streaming mode",
  "spaceResourceConfig": "Space Resource Configuration",
  "selectSpaceResources": "Select Space Resources",
  "streamingBatchSize": "Batch Size",
  "streamingBatchSizePlaceholder": "Enter batch size, default is 100",
  "batchUnit": "items",
  "streamingBatchSizeHint": "Batch size controls the number of data items processed at a time, default is 100. Larger values increase processing speed but consume more memory",
  "streamingBatchSizeMinError": "Batch size must be greater than or equal to 1",
  "streamingBatchSizeIntegerError": "Batch size must be an integer",
  "streamingBatchSizeRequired": "Please enter batch size",
}