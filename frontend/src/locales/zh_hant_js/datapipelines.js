export const dataPipelines = {
  ...
  "inProgress": "處理中",
  "completed": "已完成",
  "partialSuccessTip": "存在處理失敗的檔案，請查閱日誌查看詳情！",
  "dataSource": "數據來源",
  ...
  "streamingModeBenefits": "流式模式的優勢：",
  "streamingBenefit1": "顯著降低內存佔用，適合大規模數據處理",
  "streamingBenefit2": "邊讀邊處理，提升數據處理效率",
  "streamingBenefit3": "支持處理超大文件，不受內存限制",
  "executionModeTitle": "執行模式選擇",
  "executionMode": "執行模式",
  "normalMode": "普通模式",
  "streamingMode": "流式模式",
  "normalExecution": "普通",
  "streamingExecution": "流式",
  "streamingCompatibleDetected": "檢測到您的工作流中所有算子均支持流式模式",
  "spaceResourceConfig": "空間資源配置",
  "selectSpaceResources": "選擇空間資源",
  "streamingBatchSize": "批量大小",
  "streamingBatchSizePlaceholder": "請輸入批量大小，默認100",
  "batchUnit": "條",
  "streamingBatchSizeHint": "批量大小控制每次處理的數據條數，默認為100。數值越大，處理速度越快但佔用內存越多",
  "streamingBatchSizeMinError": "批量大小必須大於等於1",
  "streamingBatchSizeIntegerError": "批量大小必須是整數",
  "streamingBatchSizeRequired": "請輸入批量大小",
}