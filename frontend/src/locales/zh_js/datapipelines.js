export const dataPipelines = {
  ...
  "fileUpload": "文件上传",
  "fileUploadHint": "文件数据导入不在本页直接上传：请先选择下方「数据流向」（目标数据集），再点击「跳转链接」前往 CSGHub 数据集页面完成文件上传。",
  "jumpLink": "跳转链接",
  "linkSuccess": "连接成功",
  "linkError": "连接失败",
  ...
  "selectSpaceResources": "选择空间资源",
  "streamingBatchSize": "批量大小",
  "streamingBatchSizePlaceholder": "请输入批量大小，默认100",
  "batchUnit": "条",
  "streamingBatchSizeHint": "批量大小控制每次处理的数据条数，默认为100。数值越大，处理速度越快但占用内存越多",
  "streamingBatchSizeMinError": "批量大小必须大于等于1",
  "streamingBatchSizeIntegerError": "批量大小必须是整数",
  "streamingBatchSizeRequired": "请输入批量大小",
  "delSuccess": "删除成功",
  "delFailed": "删除失败",
  ...
  "streamingModeBenefits": "流式模式的优势：",
  "streamingBenefit1": "显著降低内存占用，适合大规模数据处理",
  "streamingBenefit2": "边读边处理，提升数据处理效率",
  "streamingBenefit3": "支持处理超大文件，不受内存限制",
  "executionModeTitle": "执行模式选择",
  "executionMode": "执行模式",
  "normalMode": "普通模式",
  "streamingMode": "流式模式",
  "normalExecution": "普通",
  "streamingExecution": "流式",
  "streamingCompatibleDetected": "检测到您的工作流中所有算子均支持流式模式",
  "spaceResourceConfig": "空间资源配置",
}
